<template>
  <div class="pb-32">
    ...
    <div class="relative md:w-[56vw] m-auto md:border border-[#EAEAEA]">
...
<div class="md:pb-36">
  ...
  <div class="md:grid grid-cols-3 md:px-[7vw] gap-x-4 gap-y-12">
    ...
    <div :style="{'color':item.data.color}" class="flex justify-center pt-4 md:pt-5 font-cooperbt text-xl">{{ String.fromCharCode(	0x2776 + i) }}<prismic-rich-text :field="item.data.title" class="" /></div>
    </NuxtLink>
  </div>
</div>
</div>
