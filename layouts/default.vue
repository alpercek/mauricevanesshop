<template>
  <div class="text-slate-800">
    ...
    />
    <main><nuxt /></main>
    <div v-if="this.$route.name != 'emailsuccess'" id="alper" class="fixed w-screen h-screen bg-white z-10 transition-[bottom] ease-in duration-[2000ms] delay-[2000ms] overflow-hidden bottom-0">
